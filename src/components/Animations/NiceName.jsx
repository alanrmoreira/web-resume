...
export default function NiceName(params) {

    return (

        <>
            <div id="nicaNameContainer">
                ...
                <div class="criterion">
                    <div class="text text0">A</div>
                    <div class="text text1">l</div>
                    <div class="text text2">a</div>
                    ...
                    <div class="text text9">i</div>
                    <div class="text text10">r</div>
